            ...
            <section className="py-6 mt-5 bg-gray-200 dark:text-gray-900 rounded-xl">
                <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                    <div className="py-6 md:py-0 md:px-6">
                        ...
                        <div className="space-y-4">
                            <p className="flex items-center">
                                ...
                                <span>Kumkumari,Ashulia,Dhaka,Bangladesh</span>
                            </p>
                            <p className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                    ...
                    <form  className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                        ...
                        <button type="button" className="self-center px-8 w-full text-lg bg-[#23be0a] rounded-xl btn text-white  " >Submit</button>
                    </form>
                </div>
            </section>
        </div>
